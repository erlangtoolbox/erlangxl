...
generate_to_json_field(RecordName, {Name, string, _ }, Out) ->          io:format(Out, "lists:flatten(io_lib:format(\"\\\"~p\\\": ~~p\", [strikead_json_rt:subst(R#~p.~p, undefined, null)]))", [Name, RecordName, Name]);
